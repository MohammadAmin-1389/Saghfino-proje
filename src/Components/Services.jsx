...
function Services() {
  return (
    <div className="mt-20">
      <div>
        <div className="w-157.25 flex justify-start mr-8 h-11.25">
        ...
        <div className="flex justify-between mt-7">
          <div className="w-98 h-127.75 flex-col flex items-center bg-[#F9F9F9] rounded-2xl">
            ...
            <div className="flex-col flex justify-center items-center">
              ...
              <div className="w-82 flex mt-2 justify-center h-53.5">
            ...
            <div className="w-82 mt-auto mb-4 flex justify-center items-center h-10 bg-[#CB1B1B] rounded-bl-lg">
          ...
          <div className="w-98 h-127.75 flex-col flex items-center bg-[#F9F9F9] rounded-2xl">
            ...
            <div className="w-82 mt-auto mb-4 flex justify-center items-center h-10 bg-[#CB1B1B] rounded-lg">
              <button className="text-[#FFFFFF] flex justify-center items-center text-[14px] font-medium">
                خرید خانه
              </button>
            </div>
